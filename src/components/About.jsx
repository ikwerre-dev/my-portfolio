            ...
            <div className="w-full max-w-7xl">
                <div className="flex my-5">
                    <div className="flex flex-col w-1/2">
                        ...
                        <div className="flex flex-wrap gap-5 gap-y-7 mb-12 ">
                            {[
                                { icon: <Headphones className="w-6 h-6" />, text: "Listening to Music", color: "text-[#7B3F00] font-sora" },
                                ...
                                <div key={index} className={`flex items-center bg-purple-100 rounded-full py-5 px-10 ${item.color}`}>
                                    {item.icon}
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-12 w-1/2">
                        {[
                ...
                <div className="bg-white/5 rounded-3xl p-6 md:p-8 mb-5">
                    <p className="text-2xl leading-relaxed">
                        I'm Robinson Honour Amadi, an 18-year-old tech enthusiast with a profound passion for the digital realm. I began my coding journey in 2017 and have spent the last six years immersing myself in various fields, including web development, app development, robotics, cloud computing, and game development. As a self-taught programmer, I have successfully built live projects that showcase my skills and creativity, demonstrating my ability to adapt and innovate across different technologies.
                    </p>
                    {isExpanded && (
                        <>        <p className="text-2xl pt-5 leading-relaxed">

                            In addition to my programming endeavors, I serve as a resource personnel for Airobot in Bonny Island, where I contribute my technical expertise to advance projects and initiatives that leverage robotics in practical applications. My commitment to the tech community extends beyond personal projects; I am also a dedicated tech content creator, sharing knowledge and insights through various platforms to inspire and educate others in the field.
                        </p>

                            <p className="text-2xl pt-5 leading-relaxed">
                                I have had the privilege of speaking at multiple tech events, including the Young Techies Festival, where I engage with fellow enthusiasts and professionals, sharing my experiences and insights. These opportunities have allowed me to connect with like-minded individuals and contribute to the growth of the tech community.
                            </p>
                            <p className="text-2xl pt-5 leading-relaxed">
                                Driven by insatiable curiosity and a strong knack for problem-solving, I am always eager to explore new frontiers in technology and collaborate with others to push the boundaries of what is possible. My journey in tech has just begun, and I am excited about the future and the innovations that lie ahead.
                            </p>
                        </>
                    )}
                </div>
